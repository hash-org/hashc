...
impl CompilerBuilder {
    ...
    pub fn build_with_settings(settings: CompilerSettings) -> Compiler<DefaultCompilerInterface> {
        let session = utils::emit_on_fatal_error(|| DefaultCompilerInterface::new(settings));
    ...
    pub fn build_with_interface<I: CompilerInterface + DefaultCtxQuery>(
        interface: I,
    ) -> Compiler<I> {
        Self::build(
            interface,
    ...
    pub fn build<I: CompilerInterface>(
        ...
        let mut compiler = Compiler::new(ctx, stages);
...
pub struct DefaultCompilerInterface {
...
impl DefaultCtxQuery for DefaultCompilerInterface {}

impl CompilerInterface for DefaultCompilerInterface {
...
impl SemanticAnalysisCtxQuery for DefaultCompilerInterface {
...
impl LoweringCtxQuery for DefaultCompilerInterface {
...
impl BackendCtxQuery for DefaultCompilerInterface {
...
impl LinkerCtxQuery for DefaultCompilerInterface {
