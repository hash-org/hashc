...
macro_rules! impl_access_to_tc_env {
    ($ty:ty) => {
        impl $crate::environment::tc_env::AccessToTcEnv for $ty {
            fn tc_env(&self) -> &$crate::environment::tc_env::TcEnv {
                self.tc_env
            }
        }
        ...
        impl hash_reporting::diagnostic::AccessToDiagnostics for $ty {
            ...
            fn diagnostics(&self) -> &Self::Diagnostics {
                $crate::environment::tc_env::AccessToTcEnv::diagnostics(self.tc_env())
            }
        }
