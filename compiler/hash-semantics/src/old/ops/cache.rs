...
use crate::old::storage::{AccessToStorage, StorageRef};
...
/// [Cache](crate::old::storage::cache::Cache), the manager itself does not
/// contain any logic that governs how the cache evicts its entries.
