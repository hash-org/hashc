...
use crate::old::exhaustiveness::{construct::DeconstructedCtor, deconstruct::DeconstructedPat};
...
pub struct ExhaustivenessStorage {
    /// The [crate::old::exhaustiveness::deconstruct::DeconstructedPat] store.
    pub deconstructed_pat_store: DeconstructedPatStore,

    /// The [crate::old::exhaustiveness::construct::DeconstructedCtor] store.
