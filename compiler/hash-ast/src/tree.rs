...
impl<'c> AstVisitor<'c> for AstTreeGenerator {
    ...
    fn visit_literal(
        ...
        Ok(walk::walk_literal_same_children(self, node)?)
    }
    ...
    fn visit_expression(
        ...
        Ok(walk::walk_expression_same_children(self, node)?)
    }
    ...
    fn visit_function_call_args(
        ...
        Ok(TreeNode::branch(
            "args",
            walk::walk_function_call_args(self, node)?.entries,
        ))
    }
    ...
    fn visit_type(
        ...
        Ok(walk::walk_type_same_children(self, node)?)
    }
    ...
    fn visit_map_literal(
        ...
        Ok(TreeNode::branch(
            "map",
            walk::walk_map_literal(self, node)?.entries,
        ))
    }
    ...
    fn visit_block(
        ...
        Ok(walk::walk_block_same_children(self, node)?)
    }
    ...
    fn visit_statement(
        ...
        Ok(walk::walk_statement_same_children(self, node)?)
    }
    ...
    fn visit_expr_statement(
        ...
        Ok(walk::walk_expr_statement(self, node)?.0)
    }
    ...
    fn visit_block_statement(
        ...
        Ok(walk::walk_block_statement(self, node)?.0)
    }
    ...
    fn visit_pattern(
        ...
        Ok(walk::walk_pattern_same_children(self, node)?)
    }
    ...
    fn visit_literal_pattern(
        ...
        Ok(walk::walk_literal_pattern_same_children(self, node)?)
    }
