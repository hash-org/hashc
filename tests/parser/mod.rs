...
static KEYWORDS: &str = include_str!("benches/keywords.hash");
static OPERATORS: &str = include_str!("benches/operators.hash");
static IDENTIFIERS: &str = include_str!("benches/identifiers.hash");
static NUMBERS: &str = include_str!("benches/numbers.hash");
